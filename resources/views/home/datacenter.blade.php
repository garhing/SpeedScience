        ...
        <div class="container">
            ...
            <div class="location-map location-map-lg location-map-grey">
                <div class="location-container">
                    ...
                    <div class="location location-russia animate zoomIn"><span class="location-name">
                        <span>俄罗斯</span></span><span class="location-pin"></span>
                    </div>
                    <div class="location location-shenzhen animate zoomIn"><span class="location-name">
                        <span>深圳中转</span></span><span class="location-pin"></span>
                    </div>
        ...
        <div class="container">
            <div class="section-row row">
                <div class="col-sm-6 col-sm-push-6">
                    <div class="section-image">
                        <div class="image image-local-peering">
                            <span class="user image-shadow animate zoomIn"></span>
                            <div class="location-map location-map-sm">
                                <div class="location-container"><span class="map-lines animate fadeIn"></span>
                                    <div class="location location-seattle animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-hongkong animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-los-angeles animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-dallas animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-singapore animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-atlanta animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-new-jersey animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-chicago animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-london animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-amsterdam animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-frankfurt animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-paris animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-tokyo animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="location location-sydney animate zoomIn"><span
                                                class="location-pin"></span></div>
                                    <div class="map map-grey"></div>
                                </div>
                            </div>
            ...
            <div class="section-row row">
                <div class="col-sm-6">
                    <div class="section-image">
                        <div class="image image-low-latency"><span
                                    class="computer-screen computer-screen-lg animate fadeInLeft"><span
                                        class="browser-website"></span></span><span
                                    class="stop-watch stop-watch-sm image-shadow animate fadeInRight"><span
                                        class="stop-watch-hand animate rotateIn" data-animation-delay=".5s"
                                        data-animation-duration="5s"></span></span>
                        </div>
                    </div>
                    <!-- /.section-image -->
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-push-6">
                    <div class="section-image">
                        <div class="image image-fast-network"><span class="speedometer image-shadow"><span
                                        class="speedometer-hand animate speed infinite"></span></span><span
                                    class="location-pin location-pin-lg location-pin-left"></span><span
                                    class="location-pin location-pin-lg location-pin-right"></span>
                            <span
                                    class="line-dashed-x"></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-5 col-sm-6 col-sm-pull-6">
