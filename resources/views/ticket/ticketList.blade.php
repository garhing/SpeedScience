                            ...
                            <table class="table table-hover table-light">
                                ...
                                @else
                                    @foreach($ticketList as $key => $ticket)
                                        <tr class="odd gradeX">
                                            <td> {{$key + 1}} </td>
                                            <td> <a href="{{empty($ticket->user->username) ?'#' :url('admin/userList?username=' . $ticket->user->username)}}" target="_blank">{{empty($ticket->user->username) ? '【账号已删除】' : $ticket->user->username}}</a> </td>
